...
function addMember() {
  ...
  axios.post(`${baseURL}/addMember`, { name }).then(() => {
...
function deleteMember() {
  ...
  axios.post(`${baseURL}/deleteMembers`, { name }).then(() => {
...
function addBook() {
  ...
  axios.post(`${baseURL}/addBook`, { book, qty }).then(() => {
...
function deleteBook() {
  ...
  axios.post(`${baseURL}/deleteBook`, { book }).then(() => {
...
function borrowBook() {
  ...
  axios.post(`${baseURL}/borrowBook`, { name, book, qty }).then(() => {
...
function returnBook(id) {
  axios.post(`${baseURL}/returnBook`, { id }).then(() => {
